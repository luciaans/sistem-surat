    ...
    <div class="container d-flex justify-content-center">
        <div class="welcome-container">
            ...
            <p class="welcome-text">
                Sistem ini dirancang khusus untuk memudahkan Anda dalam mengelola surat masuk dan surat keluar. Fitur-fitur yang tersedia memungkinkan Anda untuk membuat, mengedit, dan menghapus surat dengan cepat dan efisien melalui dashboard admin.
            </p>
        </div>
    </div>
</body>
